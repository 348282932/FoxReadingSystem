...
using FoxReadingSystem.MultiTenancy.Dto;
using FoxReadingSystem.Users;

namespace FoxReadingSystem.MultiTenancy
{
    [AbpAuthorize(PermissionNames.Pages_Tenants)]
    public class TenantAppService : FoxReadingSystemAppServiceBase, ITenantAppService
    {
